              ...
              <div>
                ...
                <div className="pt-4 relative px-4">
                  <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="text-neutral-600 text-xs md:text-sm lg:text-base h-40 md:h-fit pb-10 flex flex-col items-start gap-4 overflow-auto dark:text-neutral-400 [mask:linear-gradient(to_bottom,white,white,transparent)] [scrollbar-width:none]"
                  >
      ...
      <ul className="max-w-2xl mx-auto w-full gap-4">
        {cards.map((card) => (
          <motion.div
            ...
            className="p-4 flex flex-col md:flex-row justify-between items-center hover:bg-white/5 rounded-xl cursor-pointer"
          >
            ...
            <motion.button
              ...
              className="px-4 py-2 text-sm rounded-full font-bold bg-white/10 hover:bg-green-500 hover:text-white text-foreground mt-4 md:mt-0 transition-colors"
            >
              {card.ctaText}
            </motion.button>
          </motion.div>
  ...
  },
  {
    ...
    content: () => (
      <p>
        ...
        California, they have become a cultural icon in the heavy metal industry.
        <br />
        <br />
  ...
  },
  {
    ...
    content: () => (
      <p>
        ...
        London in 1968, they became a cultural icon in the rock world.
        <br />
        <br />
        Their songs reflect a blend of blues, hard rock, and folk music,
        capturing the essence of the 1970s rock era.
      </p>
    ),
  },
];
